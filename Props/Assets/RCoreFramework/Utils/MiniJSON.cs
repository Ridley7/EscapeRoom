...
public static class MiniJsonExtensions
{
    ...
    public static string GetString(this Hashtable hashtable, string key, string defaultValue = "")
    {
        ...
        {
            return hashtable[key] == null ? null : hashtable[key].ToString();
        }

        return defaultValue;
    }

    public static int GetInt(this Hashtable hashtable, string key, int defaultValue = int.MaxValue)
    {
        if (hashtable.ContainsKey(key)) return int.Parse(hashtable[key].ToString());
